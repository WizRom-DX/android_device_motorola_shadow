...
adb pull /system/lib/hw/sensors.shadow.so ../../../vendor/motorola/$DEVICE/proprietary/lib/hw
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/motorola/__DEVICE__/proprietary/lib/hw/sensors.shadow.so:/system/lib/hw/sensors.shadow.so \\
